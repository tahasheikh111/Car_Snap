"""
Django settings for car_damage_detection_web project.
...
SECRET_KEY = 'django-insecure-u=y56h%7gq0tw4y9fq4xhn*z=2)fswua%j)2v^jq2w&lkg=8+p'
...
ROOT_URLCONF = 'car_damage_detection_web.urls'
